...
INSERT INTO Access (id, name) VALUES (1, 'view ladder');
INSERT INTO Access (id, name) VALUES (2, 'create challenge');
INSERT INTO Access (id, name) VALUES (3, 'enter result');
INSERT INTO Access (id, name) VALUES (4, 'add player to ladder');
INSERT INTO Access (id, name) VALUES (5, 'see activity log');

INSERT INTO Role_Access (Role_id, access_id) VALUES (1, 1);
INSERT INTO Role_Access (Role_id, access_id) VALUES (2, 1);
INSERT INTO Role_Access (Role_id, access_id) VALUES (3, 1);
INSERT INTO Role_Access (Role_id, access_id) VALUES (4, 1);

INSERT INTO Role_Access (Role_id, access_id) VALUES (2, 2);
INSERT INTO Role_Access (Role_id, access_id) VALUES (3, 2);
INSERT INTO Role_Access (Role_id, access_id) VALUES (4, 2);

INSERT INTO Role_Access (Role_id, access_id) VALUES (2, 3);
INSERT INTO Role_Access (Role_id, access_id) VALUES (3, 3);
INSERT INTO Role_Access (Role_id, access_id) VALUES (4, 3);

INSERT INTO Role_Access (Role_id, access_id) VALUES (3, 4);
INSERT INTO Role_Access (Role_id, access_id) VALUES (4, 4);

INSERT INTO Role_Access (Role_id, access_id) VALUES (4, 5);
